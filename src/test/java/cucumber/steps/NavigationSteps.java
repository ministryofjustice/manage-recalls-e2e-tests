...
public class NavigationSteps {
    ...
    public void goToManageRecallService(String caseworker) {
    ...
    @When("{word} logs in")
    public void logIn(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
    ...
    public void entersNOMSNumber(String caseworker) {
        String nomsNumber = sessionVariableCalled(NOMS_NUMBER);
        theActorCalled(caseworker).attemptsTo(
                Click.on(FIND_SOMEONE_LINK),
                Ensure.thatTheCurrentPage().title().isEqualTo(FindAnOffenderPage.TITLE),
    ...
    public void searchResultText(String caseworker, String searchResultsText) {
        theActorCalled(caseworker).attemptsTo(
    ...
    public void matchedPersonResultsText(String caseworker, String personText) {
        theActorCalled(caseworker).attemptsTo(
    ...
    public void submitDateTimeOfRecallRequestReceived(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
                Ensure.thatTheCurrentPage().title().isEqualTo(RecallReceivedPage.TITLE),
    ...
    public void submitLatestReleaseDetails(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
    ...
    public void submitVulnerabilityAndContrabandDetails(String caseworker) {
    ...
    public void submitProbationOfficerDetails(String caseworker) {
        ...
        theActorCalled(caseworker).attemptsTo(
                Ensure.thatTheCurrentPage().title().isEqualTo(ProbationDetailsPage.TITLE),
    ...
    public void matchRecallCreatedText(String caseworker) {
        Actor actor = theActorCalled(caseworker);
        actor.attemptsTo(
                Ensure.thatTheCurrentPage().title().isEqualTo(BookRecallConfirmationPage.TITLE)
        );
    ...
    public void addReasonsForMissingDocuments(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
                Ensure.thatTheCurrentPage().title().isEqualTo(MissingDocumentsPage.TITLE),
    ...
    public void clickOnBookRecallLink(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
    ...
    public void assessRecall(String caseworker) {
        Actor actor = theActorCalled(caseworker);
    ...
    public void createDossier(String caseworker) {
        Actor actor = theActorCalled(caseworker);
        String recallId = actor.recall("RECALL_ID");
    ...
    public void bookingCheckAnswers(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
    ...
    public void clickOnAssessThisRecallButton(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
    ...
    public void confirmRecallLength(String caseworker, Integer numDays) {
        theActorCalled(caseworker).attemptsTo(
                Ensure.thatTheCurrentPage().title().isEqualTo(DecisionOnRecallRecommendationPage.TITLE),
    ...
    public void submitLicenceBreach(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
    ...
    public void submitCurrentPrison(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
    ...
    public void recordsIssuanceOfRecallNotification(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
                Ensure.thatTheCurrentPage().title().isEqualTo(RecordIssuanceOfRecallNotificationPage.TITLE),
    ...
    public void confirmRecallAuthorisation(String caseworker) {
        Actor actor = theActorCalled(caseworker);
        actor.attemptsTo(
    ...
    public void confirmUnassigned(String caseworker) {
        Actor actor = theActorCalled(caseworker);
        actor.remember("RECALL_ID", textContent(RecallAuthorisationPage.RECALL_ID));
        String recallId = actor.recall("RECALL_ID");
        actor.attemptsTo(
    ...
    public void downloadRecallDocument(String caseworker) {
        Actor actor = theActorCalled(caseworker);
        actor.attemptsTo(
                Ensure.thatTheCurrentPage().title().isEqualTo(RecallCheckAnswersPage.TITLE)
        );
    ...
    public void navigateToViewRecallAssessmentDetails(String caseworker) {
        new AssessARecallPage().open("assess.recall", withParameters(sessionVariableCalled(NOMS_NUMBER), theActorCalled(caseworker).recall("RECALL_ID")));
    }
    ...
    public void downloadEmail(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
    ...
    public void submitInfoForPrisonLetter(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
    ...
    public void checkCreateReasonsRecallDoc(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
                Ensure.thatTheCurrentPage().title().isEqualTo(CreateDossierCheckReasonsDocPage.TITLE),
    ...
    public void hasReviewedTheDossier(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
                Ensure.thatTheCurrentPage().title().isEqualTo(CreateDossierDownloadDossierAndLetterPage.TITLE),
    ...
    public void hasEmailedTheDossier(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
                Ensure.thatTheCurrentPage().title().isEqualTo(CreateDossierConfirmEmailedPage.TITLE),
    ...
    public void confirmDossierCreation(String caseworker) {
        Actor actor = theActorCalled(caseworker);
        actor.attemptsTo(
                Ensure.thatTheCurrentPage().title().isEqualTo(DossierCreationConfirmationPage.TITLE)
        );
        actor.remember("RECALL_ID", textContent(DossierCreationConfirmationPage.RECALL_ID));
    }

    @Then("{word} can see that they are unassigned from the recall after dossier creation is complete")
    public void confirmUnassignedAfterCompletionOfDossierCreation(String caseworker) {
        Actor actor = theActorCalled(caseworker);
        actor.remember("RECALL_ID", textContent(DossierCreationConfirmationPage.RECALL_ID));
        String recallId = actor.recall("RECALL_ID");
        actor.attemptsTo(
    ...
    public void downloadDossierEmail(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
    ...
    public void viewDossierCreationDetails(String caseworker) {
        theActorCalled(caseworker).attemptsTo(
                Click.on(TodoRecallsListPage.COMPLETED_TAB),
                Click.on(TodoRecallsListPage.viewLinkForRecallId(theActorCalled(caseworker).recall("RECALL_ID")))
        );
    }
