...
docker compose -f $LOCAL_DOCKER_COMPOSE_FILE pull redis gotenberg hmpps-auth fake-prisoner-offender-search-api
...
curl -s -4 --retry 10 --retry-delay 1 --retry-connrefused http://localhost:8080/health/ping
